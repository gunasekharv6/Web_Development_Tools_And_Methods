				...
				encType="multiPart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="unitPrice" id="unitPrice" min="0"
						...
						<div class="col-md-4 offset-md-4 col-md-8">
				...
				<div class="modal-body">
					...
					<sf:form id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea type="text" rows="5" path="description" id="category_description" class="form-control"/>
							</div>
						</div>
